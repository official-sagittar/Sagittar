...
namespace sagittar {
    ...
    [[nodiscard]] bool Position::isLegalMove(const Move& move) const noexcept {
        ...
        //  1. When in check, generate only check evasions and blockers
        //  2. When in check and multiple checkers exist, only generate King moves
        //  3. For casteling, approproate casteling rights and a clear path exists
