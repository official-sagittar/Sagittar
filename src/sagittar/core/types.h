...
namespace sagittar {
    ...
    namespace core {
        ...
        namespace types {
            ...
            constexpr Square rf2sq(const Rank r, const File f) {
                return static_cast<Square>(8 * r + f);
            }
            constexpr Square rf2sq(const u8 r, const u8 f) {
                return static_cast<Square>(8 * r + f);
            }
            ...
            constexpr Rank promotionRankDestOf(const Color c) {
