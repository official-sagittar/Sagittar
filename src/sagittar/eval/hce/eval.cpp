...
#include "sagittar/eval/hce/types.h"
...
namespace sagittar {
    ...
    namespace eval {
        ...
        namespace hce {
            ...
            using namespace eval::hce::types;
            ...
            Score evaluateBoard(const core::board::Board& board) {
            ...
            bool isEndGame(const core::board::Board& board) {
